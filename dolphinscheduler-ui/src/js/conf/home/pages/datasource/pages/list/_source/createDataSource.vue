  ...
  <div class="datasource-popup-model">
    ...
    <div class="content-p">
      <div class="create-datasource-model">
        <m-list-box-f>
          <template slot="name"
            ><strong>*</strong>{{ $t("Datasource") }}</template
          >
          <template slot="content">
            <x-radio-group v-model="type" size="small">
              ...
              <x-radio :label="'TRINO'" class="radio-label-last">TRINO</x-radio>
            </x-radio-group>
          </template>
        </m-list-box-f>
        <m-list-box-f>
          <template slot="name"
            ><strong>*</strong>{{ $t("Datasource Name") }}</template
          >
          <template slot="content">
            <x-input
              type="input"
        ...
        <m-list-box-f>
          <template slot="name"
            ><strong>*</strong>{{ $t("User Name") }}</template
          >
          <template slot="content">
            <x-input
              type="input"
        ...
        <m-list-box-f v-if="showCatalog">
          <template slot="name"
            ><strong>*</strong>{{ $t("Catalog Name") }}</template
          >
          <template slot="content">
            <x-input
              type="input"
              v-model="catalog"
              maxlength="60"
              :placeholder="$t('Please enter catalog name')"
              autocomplete="off"
            >
            </x-input>
          </template>
        ...
        <m-list-box-f v-if="showConnectType">
          ...
          <template slot="content">
            <x-radio-group v-model="connectType" size="small">
              <x-radio :label="'ORACLE_SERVICE_NAME'">{{
    ...
    <div class="bottom-p">
      ...
      <x-button
        ...
        @click="_testConnect()"
        :loading="testLoading"
        >{{ testLoading ? "Loading..." : $t("Test Connect") }}</x-button
      >
      <x-button
        type="primary"
        shape="circle"
...
export default {
  ...
  methods: {
    _rtOtherPlaceholder() {
      return `${i18n.$t(
        "Please enter format"
      )} {"key1":"value1","key2":"value2"...} ${i18n.$t(
    ...
    _verification() {
      ...
      if (!this.catalog && this.showCatalog == true) {
        this.$message.warning(`${i18n.$t("Please enter catalog name")}`);
        return false;
      }
